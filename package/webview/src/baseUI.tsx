...
export const icon = {
    ...
    Server(props: svgIcon) {
        var { color = "#333" } = props;
        return svgIconFactoy(props, [
            <path d="M44 4H4V20H44V4Z" fill="none" stroke="#333" stroke-width="4" stroke-linejoin="round" />,
            <path d="M44 28H4V44H44V28Z" fill="none" stroke="#333" stroke-width="4" stroke-linejoin="round" />,
            <path
