...
function emit$1(instance, event, ...rawArgs) {
  ...
  if ({}.NODE_ENV !== "production" || __VUE_PROD_DEVTOOLS__) {
...
const PublicInstanceProxyHandlers = {
  ...
  set({ _: instance }, key, value) {
    ...
    if (setupState !== EMPTY_OBJ && hasOwn(setupState, key)) {
      ...
      ({}).NODE_ENV !== "production" && warn(`Attempting to mutate prop "${key}". Props are readonly.`, instance);
      return false;
    }
    if (key[0] === "$" && key.slice(1) in instance) {
      ({}).NODE_ENV !== "production" && warn(`Attempting to mutate public property "${key}". Properties starting with $ are reserved and readonly.`, instance);
      return false;
    } else {
...
function initFeatureFlags() {
  ...
  if (typeof __VUE_OPTIONS_API__ !== "boolean") {
    ({}).NODE_ENV !== "production" && needWarn.push(`__VUE_OPTIONS_API__`);
    getGlobalThis().__VUE_OPTIONS_API__ = true;
  }
  if (typeof __VUE_PROD_DEVTOOLS__ !== "boolean") {
    ({}).NODE_ENV !== "production" && needWarn.push(`__VUE_PROD_DEVTOOLS__`);
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const mountElement = (vnode, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
    ...
    if (!({}.NODE_ENV !== "production") && vnode.el && hostCloneNode !== void 0 && patchFlag === -1) {
  ...
  const processFragment = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
    ...
    if ({}.NODE_ENV !== "production" && (isHmrUpdating || patchFlag & 2048)) {
      patchFlag = 0;
      optimized = false;
      dynamicChildren = null;
    }
...
defindeProps.required = Symbol("required");
function svgIconFactoy(props, slots) {
  var { scale = 24 } = props;
  var setProps = Object.assign({}, props, {
    width: scale,
    height: scale,
    viewBox: "0 0 48 48",
    fill: "none",
...
const UI = {
  mouseOverUI: defineComponent({
    ...
    props: defindeProps({
      ...
      MouseOverStyle: void 0,
      MouseDownStyle: void 0
    }),
    render() {
      ...
      if (this.mouseDown)
        attrs.style = Object.assign(attrs.style, mouseDownStyle);
      else if (this.mouseOver)
        attrs.style = Object.assign(attrs.style, mouseOverStyle);
      if (mouseDownStyle) {
      ...
      return h(this.$props.Element, attrs, this.$slots);
    }
  })
};
var vscode;
try {
  ...
  console.warn = function(e) {
    if (e !== "[Vue warn]: Non-function value encountered for default slot. Prefer function slots for better performance.")
      warn2(e);
  };
...
function IB(props, { slots }) {
  var style = props.style;
  if (style && !style.display)
    style.display = "inline-block";
  else
    props = Object.assign({ style: { display: "inline-block" } }, props);
  return h("div", props, {
    default() {
      return slots;
    }
...
const Head = defineComponent({
  ...
  render() {
    ...
    return /* @__PURE__ */ h(Fragment, null, /* @__PURE__ */ h("div", {
    ...
    }, /* @__PURE__ */ h("div", null, /* @__PURE__ */ h(IB, {
      title: "Reload",
      style: headIBstyle
    }, /* @__PURE__ */ h(UI.mouseOverUI, {
      Element: icon.reload,
      ...
      color: this.autoReload ? "#10cdfd" : void 0
    }))), /* @__PURE__ */ h("b", null, this.workspaceFolderName), /* @__PURE__ */ h("div", null, /* @__PURE__ */ h(IB, {
      title: "toggle watch",
      style: headIBstyle
    }, /* @__PURE__ */ h(UI.mouseOverUI, {
      Element: icon.watch,
      ...
      color: this.watch ? "#10cdfd" : void 0
    })), /* @__PURE__ */ h(IB, {
      title: "setting",
      style: headIBstyle
    }, /* @__PURE__ */ h(UI.mouseOverUI, {
    ...
    }), this.showSetting ? /* @__PURE__ */ h("div", {
      style: {
        height: "100%",
        width: "100%",
      ...
      style: { textAlign: "center", fontSize: "24px", marginBottom: "15px" }
    }, this.workspaceFolderName), /* @__PURE__ */ h("span", {
      style: { fontSize: "13px", fontWeight: "bold" }
    }, "Server root Directory: ( Relative to the workspace folder )"), /* @__PURE__ */ h("div", null, /* @__PURE__ */ h("input", {
    ...
    }))), this.workspaceFolderDir ? `Dependency packages will be installed to "${this.installDir}"` : "", /* @__PURE__ */ h("br", null), /* @__PURE__ */ h("br", null), /* @__PURE__ */ h("span", {
      style: { fontSize: "13px", fontWeight: "bold" }
    }, "Server URL: "), /* @__PURE__ */ h("br", null), /* @__PURE__ */ h("input", {
      style: { width: "300px", margin: "5px 0" },
      type: "text",
      value: this.serverURL,
      onBlur: this.updateURL
    }), /* @__PURE__ */ h("br", null), 'Enter "', this.serverURL, '" in the browser to automatically preview the components'), /* @__PURE__ */ h(UI.mouseOverUI, {
      onClick: this.setting,
      Element: "div",
      style: {
        width: "70px",
...
createApp(/* @__PURE__ */ h(Head, null)).mount(div);
